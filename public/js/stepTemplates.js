  ...
  tipo_solicitacao_selecao: `
    <div class="form-step" data-step="0">
      ...
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, selecione o tipo de solicitação.</div>
      </div>
  ...
  tipo_solicitante: `
    <div class="form-step" data-step="0">
      ...
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, informe quem você é.</div>
      </div>
      <div class="btn-group-navigation">
        <button type="button" class="btn btn-secondary" onclick="resetForm()">
          <i class="bi bi-arrow-left"></i> Voltar
  ...
  estipulante_seguradoras: `
    <div class="form-step">
      <div id="dados_estip" class="d-none">
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
            ...
            <div class="invalid-feedback">Insira o Código do Estipulante.</div>
          </div>
        </div>
        ...
        <div data-visible-when-fluxo="renovacao">
          ...
          <div id="rcf_fields" style="display: none;">
            <div id="coberturaRCFren" class="mb-4">
              ...
              <select id="valorRCF_select" class="form-select" data-rule="valorRCF_outro:outro" required>
                <option value="" disabled selected>Selecione</option>
              ...
              <div class="invalid-feedback">Por favor, selecione um valor para RCF.</div>
              <input type="number" class="form-control mt-2" id="valorRCF_outro" step="1000" style="display: none;" placeholder="Digite o valor desejado" required/>
              <div class="invalid-feedback">Por favor, insira um valor para RCF.</div>
            </div>
          </div>
          ...
          <div id="app_fields" class="mb-4" style="display: none;">
            ...
            <select id="valorAPP_select" class="form-select" data-rule="valorAPP_outro:outro" required>
              <option value="" disabled selected>Selecione</option>
              <option value="5000">R$ 5.000</option>
              <option value="10000">R$ 10.000</option>
              <option value="outro">Outro Valor</option>
            </select>
            <div class="invalid-feedback">Por favor, selecione um valor para APP.</div>
            <input type="number" class="form-control mt-2" id="valorAPP_outro" step="1000" style="display: none;" placeholder="Digite o valor desejado" required/>
            <div class="invalid-feedback">Por favor, insira um valor para APP.</div>
          </div>
        </div>
            ...
            <div data-visible-when-fluxo="nova">
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <div class="invalid-feedback">Por favor, selecione a cobertura RCF.</div>
                </div>
                <div class="col-md-6 mb-3">
                  ...
                  <div class="invalid-feedback">Por favor, selecione a cobertura APP.</div>
                </div>
              </div>
            </div>
      ...
      <div data-visible-when-solicitante="colaborador">
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
            ...
            <select id="segTrabalhadas" class="form-select" multiple name="segTrabalhadas[]" data-rule="seguradoraContainer:Outra" required>
            ...
            <div class="invalid-feedback">Por favor, selecione ao menos uma seguradora.</div>
          </div>
          <div class="mb-3" id="seguradoraContainer" style="display: none;">
            ...
            <input type="text" id="seguradoraNome" class="form-control" required/>
            <div class="invalid-feedback">Por favor, informe o nome da seguradora.</div>
          </div>
        </div>
      </div>
        ...
        <div id="parcelamento_fields">
          ...
          <div class="row">
            <div class="col-md-12 mb-3">
              ...
              <div class="invalid-feedback">Por favor, selecione a quantidade de parcelas.</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="cotacao-container" class="mb-3" data-visible-when-solicitante="colaborador, parceiro">
        ...
        <div class="invalid-feedback">Por favor, faça o upload da cotação.</div>
      </div>
    ...
    <div class="form-step">
        ...
        <div id="cotacao_extra_fields" style="display: none;">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <div class="invalid-feedback">Por favor, selecione o estado civil.</div>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <div class="invalid-feedback">Por favor, informe o CEP de pernoite.</div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <input type="number" id="segurado_numero_cotacao" class="form-control" required>
      ...
      <div id="empresarial_fields" style="display: none;">
        ...
        <div class="mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe a atividade principal.</div>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe o limite de cobertura.</div>
        </div>
        <div class="mb-3">
            ...
            <div class="invalid-feedback">Por favor, selecione a cobertura desejada.</div>
        </div>
        <div class="mb-3">
      ...
      <div id="veiculoFields" style="display: none;">
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            ...
            <div class="invalid-feedback">Insira a placa do veículo.</div>
          </div>
          <div class="col-md-4 mb-3">
            <label class="form-label">Chassi *</label>
            <input id="veiChassi" class="form-control" minlength="5" required />
            <div class="invalid-feedback">Insira o chassi do veículo.</div>
          </div>
          <div class="col-md-4 mb-3">
            <label class="form-label">Renavam *</label>
            <input id="veiRenavam" class="form-control" required />
            <div class="invalid-feedback">Insira o Renavam do veículo.</div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4 mb-3">
            ...
            <div class="invalid-feedback">Insira o fabricante do veículo.</div>
          </div>
          <div class="col-md-4 mb-3">
            <label class="form-label">Modelo *</label>
            <input id="veiModelo" class="form-control" required />
            <div class="invalid-feedback">Insira o modelo do veículo.</div>
          </div>
          <div class="col-md-4 mb-3">
            <label class="form-label">Ano *</label>
            <input id="veiAno" type="number" class="form-control" min="1980" max="2099" required />
            <div class="invalid-feedback">Insira o ano do veículo.</div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Selecione o uso do veículo.</div>
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label">Lotação *</label>
            <input id="veiLotacao" type="number" class="form-control" min="1" required />
            <div class="invalid-feedback">Insira a lotação do veículo.</div>
          </div>
        </div>
        <div class="row" id="tigoClubeQuestionContainer" style="display: none;">
          ...
          <input id="tigoClubeAdesao" type="file" class="form-control" accept=".pdf,.jpg,.jpeg,.png" required/>
      ...
      <div id="seguro_vida_fields" style="display: none;">
        ...
        <div class="row">
          ...
          <div id="vidaQuaisDoencasPreExistentesContainer" class="col-md-9 mb-3" style="display: none;">
            ...
            <textarea id="vidaQuaisDoencasPreExistentes" class="form-control" rows="2" required></textarea>
            <div class="invalid-feedback">Por favor, informe quais são as doenças.</div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div id="vidaQuaisCirurgiasAnterioresContainer" class="col-md-9 mb-3" style="display: none;">
            ...
            <textarea id="vidaQuaisCirurgiasAnteriores" class="form-control" rows="2" required></textarea>
            <div class="invalid-feedback">Por favor, informe quais foram as cirurgias.</div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div id="vidaQuaisDoencasFamiliaresContainer" class="col-md-9 mb-3" style="display: none;">
            ...
            <textarea id="vidaQuaisDoencasFamiliares" class="form-control" rows="2" required></textarea>
            <div class="invalid-feedback">Por favor, informe quais são as doenças familiares.</div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div id="vidaQuaisAtividadesFisicasContainer" class="col-md-9 mb-3" style="display: none;">
            ...
            <textarea id="vidaQuaisAtividadesFisicas" class="form-control" rows="2" required></textarea>
            <div class="invalid-feedback">Por favor, informe quais atividades físicas pratica.</div>
          </div>
        </div>
          ...
          <div class="beneficiario-block mb-3">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input id="vidaBeneficiario1Nome" class="form-control" required/>
                <div class="invalid-feedback">Por favor, informe o nome completo.</div>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">CPF *</label>
                <input id="vidaBeneficiario1CPF" class="form-control" placeholder="000.000.000-00" required/>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="date" id="vidaBeneficiario1Nascimento" class="form-control" required/>
                <div class="invalid-feedback">Por favor, informe a data de nascimento.</div>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">Sexo *</label>
                <select id="vidaBeneficiario1Sexo" class="form-select" required>
                  <option value="">Selecione</option>
            ...
            <div class="mb-3">
              ...
              <input id="vidaBeneficiario1Parentesco" class="form-control" required/>
      ...
      <div id="seguro_viagem_fields" style="display: none;">
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe o destino da viagem.</div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe a data de ida.</div>
          </div>
          <div class="col-md-6 mb-3">
            <label for="viagemVolta" class="form-label">Data de Volta *</label>
            <input type="date" id="viagemVolta" class="form-control" required>
            <div class="invalid-feedback">Por favor, informe a data de volta.</div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe o número de viajantes.</div>
          </div>
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe as idades dos viajantes.</div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, selecione o motivo da viagem.</div>
          </div>
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, selecione o tipo de viagem.</div>
          </div>
        </div>
      ...
      <div id="rc_profissional_fields" style="display: none;">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe o CPF ou CNPJ.</div>
          </div>
        </div>
        <div class="mb-3">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe a profissão/área.</div>
          </div>
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe o tempo de experiência.</div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe o número de profissionais.</div>
          </div>
          <div class="col-md-6 mb-3">
        ...
        <div class="mb-3">
          ...
          <div class="invalid-feedback">Por favor, informe o limite da apólice.</div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="invalid-feedback">Por favor, descreva as atividades exercidas.</div>
        </div>
        ...
        <div id="rcpReclamacoesDescricaoContainer" class="mb-3" style="display: none;">
          ...
          <textarea id="rcpReclamacoesDescricao" class="form-control" rows="3" required></textarea>
          <div class="invalid-feedback">Por favor, descreva as reclamações.</div>
        </div>
      ...
      <div id="carta_verde_fields" style="display: none;">
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
            ...
            <div class="invalid-feedback">Por favor, selecione o destino.</div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 mb-3">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe o nome do condutor.</div>
          </div>
          <div class="col-md-6 mb-3">
            <label for="cvCondutorCpf" class="form-label">CPF</label>
            <input type="text" id="cvCondutorCpf" class="form-control">
            <div class="invalid-feedback">Por favor, informe o CPF do condutor.</div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe a data de nascimento do condutor.</div>
          </div>
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, selecione o sexo do condutor.</div>
          </div>
        </div>
        <div class="mb-3">
          <label for="cvCondutorIdAnexo" class="form-label">ID anexo</label>
          <input type="file" id="cvCondutorIdAnexo" class="form-control">
          <div class="invalid-feedback">Por favor, anexe o ID do condutor.</div>
        </div>
      </div>
      ...
      <div id="auto_compreensivo_fields" style="display: none;">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3" id="notaFiscal0kmContainer" style="display: none;">
            ...
            <div class="invalid-feedback">Por favor, anexe a nota fiscal.</div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3" id="notaFiscalIsencaoContainer" style="display: none;">
            ...
            <div class="invalid-feedback">Por favor, anexe o documento de isenção.</div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, selecione o tipo de câmbio.</div>
          </div>
          <div class="col-md-6 mb-3">
        ...
        <div class="mb-3" id="apoliceVigenteContainer" style="display: none;">
          ...
          <input id="apoliceVigente" type="file" class="form-control" accept=".pdf,.jpg,.jpeg,.png" required>
          <div class="invalid-feedback">Por favor, anexe a apólice vigente.</div>
        </div>
        ...
        <div class="mb-3" id="tipoGaragemContainer" style="display: none;">
          ...
          <select id="tipoGaragem" class="form-select" required>
            <option value="">Selecione</option>
            <option value="fechada">Fechada</option>
            <option value="aberta">Aberta</option>
            <option value="estacionamento">Estacionamento</option>
          </select>
          <div class="invalid-feedback">Por favor, selecione o tipo de garagem.</div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe a distância média.</div>
          </div>
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Por favor, selecione a frequência de uso.</div>
          </div>
        </div>
        ...
        <div id="motoristaAuxiliarContainer" style="display: none;">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <label class="form-label">Nome Completo</label>
              <input id="auxNome" class="form-control" required>
              <div class="invalid-feedback">Por favor, informe o nome completo.</div>
            </div>
            <div class="col-md-6 mb-3">
              <label class="form-label">CPF</label>
              <input id="auxCPF" class="form-control" required>
              <div class="invalid-feedback">Por favor, informe o CPF.</div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 mb-3">
              <label class="form-label">Data de Nascimento</label>
              <input type="date" id="auxDataNascimento" class="form-control" required>
              <div class="invalid-feedback">Por favor, informe a data de nascimento.</div>
            </div>
            <div class="col-md-6 mb-3">
              <label class="form-label">Estado Civil</label>
              <select id="auxEstadoCivil" class="form-select" required>
                <option value="">Selecione</option>
                <option>Solteiro(a)</option>
                <option>Casado(a)</option>
                <option>Divorciado(a)</option>
  ...
  aviso_sinistro: `
    <div class="form-step">
      ...
      <div class="mb-3">
        ...
        <input type="text" id="sinistroNomeSegurado" class="form-control" required />
        <div class="invalid-feedback">Por favor, informe o nome do segurado.</div>
      </div>
      <div class="mb-3">
        <label for="sinistroEmailSegurado" class="form-label">E-mail do Segurado: *</label>
        <input type="email" id="sinistroEmailSegurado" class="form-control" required />
        <div class="invalid-feedback">Por favor, informe o e-mail do segurado.</div>
      </div>
      <div class="mb-3">
        <label for="sinistroNumeroApolice" class="form-label">Número da apólice: *</label>
        <input type="text" id="sinistroNumeroApolice" class="form-control" required />
        <div class="invalid-feedback">Por favor, informe o número da apólice.</div>
      </div>
      <div class="row"> 
        <div class="col-md-4 mb-3">
          <label for="sinistroMarcaVeiculo" class="form-label">Marca do veículo: *</label>
          <input type="text" id="sinistroMarcaVeiculo" class="form-control" required />
        ...
        <div class="col-md-4 mb-3">
          ...
          <input type="text" id="sinistroModeloVeiculo" class="form-control" required />
        ...
        <div class="col-md-4 mb-3">
          ...
          <input type="number" id="sinistroAnoFabricacaoVeiculo" class="form-control" required />
          <div class="invalid-feedback">Por favor, informe o ano de fabricação.</div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 mb-3">
          <label for="sinistroAnoModeloVeiculo" class="form-label">Ano do modelo do veículo: *</label>
          <input type="number" id="sinistroAnoModeloVeiculo" class="form-control" required />
          <div class="invalid-feedback">Por favor, informe o ano do modelo.</div>
        </div>
        <div class="col-md-6 mb-3">
          <label for="sinistroPlacaSegurado" class="form-label">Placa: *</label>
          <input type="text" id="sinistroPlacaSegurado" class="form-control" required />
  ...
  aviso_sinistro_terceiro: `
    <div class="form-step">
      ...
      <div class="mb-3">
        ...
        <select id="sinistroCategoriaDano" class="form-select" required>
          <option value="">Selecione</option>
        ...
        <div class="invalid-feedback">Por favor, selecione a categoria do dano.</div>
      </div>
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, informe o nome do terceiro.</div>
      </div>
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, informe o endereço do terceiro.</div>
      </div>
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <div class="invalid-feedback">Por favor, informe o telefone do terceiro.</div>
        </div>
        <div class="col-md-6 mb-3">
          ...
          <div class="invalid-feedback">Por favor, informe o e-mail do terceiro.</div>
        </div>
      </div>
    ...
    <div class="form-step">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="text" id="sinistroPais" class="form-control" value="Brasil" readonly required />
        </div>
        <div class="col-md-6 mb-3">
          <label for="sinistroEstado" class="form-label">Estado do sinistro: *</label>
          <input type="text" id="sinistroEstado" class="form-control" required />
          <div class="invalid-feedback">Por favor, informe o estado do sinistro.</div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 mb-3">
          <label for="sinistroCidade" class="form-label">Cidade do sinistro: *</label>
          <input type="text" id="sinistroCidade" class="form-control" required />
          <div class="invalid-feedback">Por favor, informe a cidade do sinistro.</div>
        </div>
        <div class="col-md-6 mb-3">
          <label for="sinistroCep" class="form-label">CEP do local do sinistro: *</label>
          <input type="text" id="sinistroCep" class="form-control" required />
          <div class="invalid-feedback">Por favor, informe o CEP do local do sinistro.</div>
        </div>
      </div>
      <div class="mb-3">
        <label for="sinistroNumeroLocal" class="form-label">Número do local do sinistro: *</label>
        <input type="text" id="sinistroNumeroLocal" class="form-control" required />
        <div class="invalid-feedback">Por favor, informe o número do local do sinistro.</div>
      </div>
      <div class="mb-3">
        <label for="sinistroEnderecoEvento" class="form-label">Endereço do evento: *</label>
        <input type="text" id="sinistroEnderecoEvento" class="form-control" required />
        <div class="invalid-feedback">Por favor, informe o endereço do evento.</div>
      </div>
      <div class="row">
        <div class="col-md-6 mb-3">
          <label for="sinistroDataHoraOcorrencia" class="form-label">Data e hora da ocorrência: *</label>
          <input type="datetime-local" id="sinistroDataHoraOcorrencia" class="form-control" required />
          <div class="invalid-feedback">Por favor, informe a data e hora da ocorrência.</div>
        </div>
        <div class="col-md-6 mb-3">
          <label for="sinistroDescricao" class="form-label">Descrição do sinistro: *</label>
          <textarea id="sinistroDescricao" class="form-control" rows="3" required></textarea>
          <div class="invalid-feedback">Por favor, descreva o sinistro.</div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 mb-3">
      ...
      <div class="mb-3">
        ...
        <div class="d-flex gap-3">
          <div class="form-check">
            <input class="form-check-input" type="radio" name="sinistroResponsabilidade" id="sinistroResponsabilidadeSim" value="sim" data-rule="sinistroMotivoResponsabilidadeContainer:checked" required/>
            <label class="form-check-label" for="sinistroResponsabilidadeSim">Sim</label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="sinistroResponsabilidade" id="sinistroResponsabilidadeNao" value="nao" required/>
      ...
      <div class="mb-3" id="sinistroMotivoResponsabilidadeContainer" style="display: none;">
        ...
        <textarea id="sinistroMotivoResponsabilidade" class="form-control" rows="2" required></textarea>
  ...
  aviso_sinistro_documentos_terceiro: `
    <div class="form-step">
      ...
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe o aviso de sinistro.</div>
      </div>
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe a CNH do condutor.</div>
      </div>
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe o CRLV do veículo do terceiro.</div>
      </div>
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe as fotos do veículo no local.</div>
      </div>
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe as fotos do veículo do terceiro.</div>
      </div>
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, informe os dados da oficina.</div>
      </div>
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe os orçamentos.</div>
      </div>
  ...
  aviso_sinistro_documentos: `
    <div class="form-step">
      ...
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe o boletim de ocorrência.</div>
      </div>
      ...
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe o CRLV do veículo segurado.</div>
      </div>
      ...
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe as fotos do veículo no local do acidente.</div>
      </div>
      ...
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe as fotos do veículo.</div>
      </div>
      ...
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe o relatório do rastreador/tacógrafo.</div>
      </div>
      ...
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe o print da tela do Carioca Digital.</div>
      </div>
      ...
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe a carta de próprio punho.</div>
      </div>
      ...
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe o croqui do acidente.</div>
      </div>
    ...
    <div class="form-step" data-step="5">
      ...
      <div class="row">
          <div class="col-md-6 mb-3">
              ...
              <div class="invalid-feedback">Por favor, informe a data de emissão.</div>
          </div>
          <div class="col-md-6 mb-3">
              <label class="form-label">Estrangeiro? *</label>
              <div class="d-flex gap-3">
                  <div class="form-check">
                      <input class="form-check-input" type="radio" name="seguradoEstrangeiro" id="seguradoEstrangeiroSim" value="sim" data-rule="seguradoBlocoEstrangeiro:checked" required/>
                      <label class="form-check-label" for="seguradoEstrangeiroSim">Sim</label>
                  </div>
                  <div class="form-check">
                      <input class="form-check-input" type="radio" name="seguradoEstrangeiro" id="seguradoEstrangeiroNao" value="nao"  checked required/>
      ...
      <div id="seguradoBlocoEstrangeiro" style="display: none;">
          <div class="row">
              ...
              <div class="col-md-4 mb-3">
                  ...
                  <div class="invalid-feedback">Por favor, informe o tempo no país.</div>
              </div>
              <div class="col-md-4 mb-3">
                  <label class="form-label">País de Residência</label>
                  <input id="seguradoPaisResidencia" class="form-control" />
                  <div class="invalid-feedback">Por favor, informe o país de residência.</div>
              </div>
          </div>
      </div>
      <div class="row">
      ...
      <div class="row">
          ...
          <div class="col-md-4 mb-3">
              ...
              <div class="d-flex gap-3">
                  <div class="form-check">
                      <input class="form-check-input" type="radio" name="seguradoPPE" id="seguradoPPESim" value="sim" data-rule="seguradoBlocoPPE:checked" required/>
                      <label class="form-check-label" for="seguradoPPESim">Sim</label>
                  </div>
                  <div class="form-check">
                      <input class="form-check-input" type="radio" name="seguradoPPE" id="seguradoPPENao" value="nao"  checked required/>
      ...
      <div id="seguradoBlocoPPE" style="display: none;">
          <div class="row">
              <div class="col-md-4 mb-3">
                  <label class="form-label">Nome</label>
                  <input id="seguradoPPENome" class="form-control" required/>
                  <div class="invalid-feedback">Por favor, informe o nome.</div>
              </div>
              <div class="col-md-4 mb-3">
                  <label class="form-label">CPF</label>
                  <input id="seguradoPPECPF" class="form-control" required/>
                  <div class="invalid-feedback">Por favor, informe o CPF.</div>
              </div>
              <div class="col-md-4 mb-3">
                  <label class="form-label">Grau de Relacionamento</label>
                  <input id="seguradoPPEGrauRelacionamento" class="form-control" required/>
                  <div class="invalid-feedback">Por favor, informe o grau de relacionamento.</div>
              </div>
          </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-3">
          <label class="form-label">Número</label>
          <input type="number"  id="segurado_numero" class="form-control" required>
          <div class="invalid-feedback">Por favor, informe o número.</div>
        </div>
      </div>
      <div class="row">
      ...
      <div class="mb-3">
        ...
        <div class="invalid-feedback">Por favor, anexe a CNH.</div>
      </div>
    ...
    <div class="form-step" data-step="5">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <div class="invalid-feedback">Por favor, informe o código do colaborador.</div>
    ...
    <div class="form-step" data-step="5">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input id="nomeCliente" class="form-control" placeholder="Nome Completo" required/>
          <div class="invalid-feedback">Por favor, informe o nome do cliente.</div>
        </div>
        <div class="col-md-6 mb-3">
          <label class="form-label">CPF ou CNPJ *</label>
          <input id="doc_cliente" class="form-control" placeholder="CPF ou CNPJ" required />
          <div class="invalid-feedback">Por favor, informe o CPF ou CNPJ do cliente.</div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 mb-3">
          <label for="emailCliente" class="form-label">Email *</label>
          <input type="email" id="emailCliente" placeholder="Email" class="form-control" required />
          <div class="invalid-feedback">Por favor, informe um e-mail válido.</div>
        </div>
        <div class="col-md-6 mb-3">
          <label class="form-label">Telefone *</label>
          <input type="phone" id="telefoneCliente" class="form-control" placeholder="Telefone" required />
          <div class="invalid-feedback">Por favor, informe um telefone válido.</div>
        </div>
      </div>
    ...
    <div class="form-step" data-step="5" id="veiculoFields">
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-3">
          <label class="form-label">Chassi *</label>
          <input id="veiChassi" class="form-control" minlength="5" required />
          <div class="invalid-feedback">Por favor, informe o chassi do veículo.</div>
        </div>
        <div class="col-md-4 mb-3">
          <label class="form-label">Renavam *</label>
          <input id="veiRenavam" class="form-control" required />
          <div class="invalid-feedback">Por favor, informe o Renavam do veículo.</div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-4 mb-3">
          <label class="form-label">Fabricante *</label>
          <input id="veiFab" class="form-control" required />
          <div class="invalid-feedback">Por favor, informe o fabricante do veículo.</div>
        </div>
        <div class="col-md-4 mb-3">
          <label class="form-label">Modelo *</label>
          <input id="veiModelo" class="form-control" required />
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <div class="invalid-feedback">Por favor, selecione o uso do veículo.</div>
        </div>
        <div class="col-md-6 mb-3">
          <label class="form-label">Lotação *</label>
          <input id="veiLotacao" type="number" class="form-control" min="1" required />
          <div class="invalid-feedback">Por favor, informe a lotação do veículo.</div>
        </div>
      </div>
      <div class="row" id="tigoClubeQuestionContainer" style="display: none;">
        <div class="col-md-12 mb-3">
            ...
            <div class="d-flex gap-3">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="tigoClube" id="tigoClubeSim" value="sim" data-rule="tigoClubeAdesaoContainer:checked" required/>
                    <label class="form-check-label" for="tigoClubeSim">Sim</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="tigoClube" id="tigoClubeNao" value="nao"  checked required/>
                    <label class="form-check-label" for="tigoClubeNao">Não</label>
                </div>
            </div>
            <div class="invalid-feedback">Por favor, selecione uma opção.</div>
      ...
      <div id="tigoClubeAdesaoContainer" class="mb-3" style="display: none;">
        <label class="form-label">Upload do documento de adesão assinado (PDF/JPG/PNG) *</label>
        <input id="tigoClubeAdesao" type="file" class="form-control" accept=".pdf,.jpg,.jpeg,.png" required/>
        <div class="invalid-feedback">Por favor, anexe o documento de adesão.</div>
      </div>
      <div class="mb-3">
        <label class="form-label">Upload CLRV (PDF/JPG/PNG) *</label>
        <input id="veiCNH" type="file" class="form-control" accept=".pdf,.jpg,.jpeg,.png"  required/>
        <div class="invalid-feedback">Por favor, anexe o CRLV.</div>
      </div>
      <div class="btn-group-navigation">
        <button type="button" class="btn btn-secondary" onclick="prevStep()">
          <i class="bi bi-arrow-left"></i> Voltar
      ...
      <div id="auxiliaresContainer" style="display: none;">
        <div class="auxiliar-block mb-3">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <label class="form-label">Nome Completo *</label>
              <input id="aux1Nome" class="form-control" required/>
              <div class="invalid-feedback">Por favor, informe o nome completo do condutor auxiliar.</div>
            </div>
            <div class="col-md-6 mb-3">
              <label class="form-label">CPF *</label>
              <input id="aux1CPF" class="form-control" placeholder="000.000.000-00" required/>
              <div class="invalid-feedback">Por favor, informe o CPF do condutor auxiliar.</div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 mb-3">
              <label class="form-label">Upload CNH (PDF/JPG/PNG) *</label>
              <input id="aux1CNH" type="file" class="form-control" accept=".pdf,.jpg,.jpeg,.png" required/>
              <div class="invalid-feedback">Por favor, anexe a CNH do condutor auxiliar.</div>
            </div>
        ...
        <div id="auxiliar2Container" style="display: none;" class="auxiliar-block mb-3">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <label class="form-label">Nome Completo *</label>
              <input id="aux2Nome" class="form-control" required/>
              <div class="invalid-feedback">Por favor, informe o nome completo do segundo condutor auxiliar.</div>
            </div>
            <div class="col-md-6 mb-3">
              <label class="form-label">CPF *</label>
              <input id="aux2CPF" class="form-control" placeholder="000.000.000-00" required/>
              <div class="invalid-feedback">Por favor, informe o CPF do segundo condutor auxiliar.</div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 mb-3">
              <label class="form-label">Upload CNH (PDF/JPG/PNG) *</label>
              <input id="aux2CNH" type="file" class="form-control" accept=".pdf,.jpg,.jpeg,.png" required/>
              <div class="invalid-feedback">Por favor, anexe a CNH do segundo condutor auxiliar.</div>
            </div>
            <div class="col-md-6 mb-3" data-visible-when-fluxo="cotacao">
              <label class="form-label">Estado Civil</label>
    ...
    <div class="form-step" data-step="6">
      ...
      <div class="row">
        <div class="col-md-12 mb-3">
          <label for="codigo" class="form-label">Código Estipulante *</label>
          <input id="codigo" class="form-control" placeholder="10L4" required>
          <div class="invalid-feedback">Por favor, informe o código do estipulante.</div>
        </div>
      </div>
  ...
  consentimento: `
    <div class="form-step" data-step="7">
      ...
      <div class="form-check mb-3">
        ...
        <div class="invalid-feedback">Você deve concordar com os termos e condições.</div>
      </div>

      <div class="my-3">
        <label class="form-label">Termo de adesão ao estipulante (PDF/JPG/PNG) *</label>
        <input id="termoAdesao" type="file" class="form-control" accept=".pdf,.jpg,.jpeg,.png"  required/>
        <div class="invalid-feedback">Por favor, anexe o termo de adesão.</div>
      </div>
    ...
    <div class="form-step" data-step="1">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input id="renovApolice" class="form-control"  placeholder="Ex: 938-..." required/>
          <div class="invalid-feedback">Por favor, informe o número da apólice.</div>
        </div>
        <div class="col-md-6 mb-3">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <div class="invalid-feedback">Por favor, selecione a seguradora.</div>
        </div>
        <div class="col-md-6 mb-3">
        ...
        <div class="form-step" data-step="1">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <div class="invalid-feedback">Por favor, informe o nome completo ou razão social.</div>
            </div>
            <div class="col-md-6 mb-3">
              <label class="form-label">CPF ou CNPJ *</label>
          ...
          <div id="apolices-container">
            <div class="row apolice-entry mb-3">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" name="apolice_1" required>
                <div class="invalid-feedback">Por favor, informe o número da apólice.</div>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">Seguradora da Apólice 1</label>
                <select class="form-select" name="seguradora_apolice_1" required>
                  <option value="">Selecione</option>
                  <option value="aruana">Aruana</option>
                  <option value="porto">Porto Seguro</option>
                  <option value="azul">Azul</option>
  ...
  <div class="form-step">
    ...
    <div class="row">
      <div class="col-md-6 mb-3">
        ...
        <div class="invalid-feedback">Por favor, informe o nome do novo titular.</div>
      </div>
      <div class="col-md-6 mb-3">
        <label for="trocaCPF" class="form-label">CPF *</label>
        <input type="text" id="trocaCPF" class="form-control" required>
        <div class="invalid-feedback">Por favor, informe o CPF do novo titular.</div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6 mb-3">
    ...
    <div class="row">
      <div class="col-md-6 mb-3">
        ...
        <div class="invalid-feedback">Por favor, informe o CEP de residência.</div>
      </div>
      <div class="col-md-6 mb-3">
    ...
    <div id="trocaMotoristaJovemContainer" style="display: none;">
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="text" id="trocaMotoristaJovemNome" class="form-control" required>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" id="trocaMotoristaJovemCPF" class="form-control" required>
                <div class="invalid-feedback">Por favor, informe o CPF do motorista.</div>
            </div>
            <div class="col-md-4 mb-3">
                <label for="trocaMotoristaJovemNascimento" class="form-label">Data de Nascimento *</label>
                <input type="date" id="trocaMotoristaJovemNascimento" class="form-control" required>
                <div class="invalid-feedback">Por favor, informe a data de nascimento do motorista.</div>
            </div>
        </div>
        <div class="mb-3">
          <label class="form-label">Upload CNH do Motorista Jovem *</label>
          <input id="trocaCNHJovem" type="file" class="form-control" accept=".jpg,.jpeg,.png,.pdf" required>
          <div class="invalid-feedback">Por favor, anexe a CNH do motorista.</div>
        </div>
    ...
    <div id="trocaOutroPrincipalContainer" style="display: none;">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" id="trocaPrincipalNome" class="form-control" required>
                <div class="invalid-feedback">Por favor, informe o nome do motorista principal.</div>
            </div>
            <div class="col-md-6 mb-3">
                <label for="trocaPrincipalCPF" class="form-label">CPF *</label>
                <input type="text" id="trocaPrincipalCPF" class="form-control" required>
                <div class="invalid-feedback">Por favor, informe o CPF do motorista principal.</div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 mb-3">
                <label for="trocaPrincipalNascimento" class="form-label">Data de Nascimento *</label>
                <input type="date" id="trocaPrincipalNascimento" class="form-control" required>
                <div class="invalid-feedback">Por favor, informe a data de nascimento.</div>
            </div>
            <div class="col-md-4 mb-3">
                <label for="trocaPrincipalEstadoCivil" class="form-label">Estado Civil *</label>
                <select id="trocaPrincipalEstadoCivil" class="form-select" required>
                    <option value="">Selecione</option>
                    <option>Solteiro(a)</option>
                    <option>Casado(a)</option>
                    <option>Divorciado(a)</option>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" id="trocaPrincipalVinculo" class="form-control" required>
                <div class="invalid-feedback">Por favor, informe o vínculo com o segurado.</div>
            </div>
        </div>
        <div class="mb-3">
          <label class="form-label">Upload CNH do Principal Motorista *</label>
          <input id="trocaCNHPrincipal" type="file" class="form-control" accept=".jpg,.jpeg,.png,.pdf" required>
          <div class="invalid-feedback">Por favor, anexe a CNH do motorista principal.</div>
        </div>
    </div>
    ...
    <div class="mb-3">
      ...
      <div class="invalid-feedback">Por favor, anexe a CNH do novo titular.</div>
    </div>
        ...
        <div class="form-step" data-step="2">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <div class="invalid-feedback">Por favor, informe a placa atual do veículo.</div>
            </div>
            <div class="col-md-6 mb-3">
              <label class="form-label">Placa Nova *</label>
              <input id="endossoVeiculoPlacaNova" class="form-control" required />
              <div class="invalid-feedback">Por favor, informe a nova placa do veículo.</div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 mb-3">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <div class="invalid-feedback">Por favor, informe o ano de fabricação/modelo.</div>
            </div>
            <div class="col-md-6 mb-3">
              <label class="form-label">Lotação *</label>
          ...
          <div class="mb-3">
            ...
            <div class="invalid-feedback">Por favor, anexe o CRLV do veículo.</div>
          </div>
          <div class="btn-group-navigation">
            <button type="button" class="btn btn-secondary" onclick="prevStep()"><i class="bi bi-arrow-left"></i> Voltar</button>
  ...
  endosso_qa_inicial: `
        <div class="form-step" data-step="2">
          ...
          <div class="mb-3">
            ...
            <div class="invalid-feedback">Por favor, selecione a quantidade de condutores.</div>
          </div>
          <div class="btn-group-navigation">
            <button type="button" class="btn btn-secondary" onclick="prevStep()"><i class="bi bi-arrow-left"></i> Voltar</button>
            <button type="button" class="btn btn-primary" onclick="nextStep()">Próximo <i class="bi bi-arrow-right"></i></button>
  ...
  endosso_acao_qa0: `
        <div class="form-step" data-step="3">
          ...
          <div class="mb-3">
            ...
            <div class="invalid-feedback">Por favor, selecione uma ação.</div>
          </div>
          <div class="btn-group-navigation">
            <button type="button" class="btn btn-secondary" onclick="prevStep()"><i class="bi bi-arrow-left"></i> Voltar</button>
            <button type="button" class="btn btn-primary" onclick="nextStep()">Próximo <i class="bi bi-arrow-right"></i></button>
  ...
  endosso_alteracao_contato: `
        <div class="form-step" data-step="2">
          ...
          <div class="mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe o novo endereço.</div>
          </div>
          <div class="row">
            <div class="col-md-6 mb-3">
          ...
          <div class="mb-3">
            ...
            <div class="invalid-feedback">Por favor, anexe o comprovante de endereço.</div>
          </div>
          <div class="btn-group-navigation">
            <button type="button" class="btn btn-secondary" onclick="prevStep()"><i class="bi bi-arrow-left"></i> Voltar</button>
            <button type="button" class="btn btn-primary" onclick="nextStep()">Próximo <i class="bi bi-arrow-right"></i></button>
        ...
        <div class="form-step" data-step="2">
          ...
          <div id="blocoPF">
            <div class="row">
              <div class="col-md-6 mb-3">
                <label class="form-label">Nome completo *</label>
                <input id="segNomePF" class="form-control" required/>
                <div class="invalid-feedback">Por favor, informe o nome completo.</div>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">CPF *</label>
                <input id="segCPF" class="form-control" placeholder="000.000.000-00" required/>
                <div class="invalid-feedback">Por favor, informe o CPF.</div>
              </div>
            </div>
          </div>
          <div id="blocoPJ" style="display: none">
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input id="segRazao" class="form-control" required/>
                <div class="invalid-feedback">Por favor, informe a razão social.</div>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">CNPJ *</label>
                <input id="segCNPJ" class="form-control" placeholder="00000000000000" required/>
                <div class="invalid-feedback">Por favor, informe o CNPJ.</div>
              </div>
            </div>
          </div>
          <div class="mb-3">
            ...
            <div class="invalid-feedback">Por favor, anexe a CNH do segurado.</div>
          </div>
          <div class="btn-group-navigation">
            <button type="button" class="btn btn-secondary" onclick="prevStep()"><i class="bi bi-arrow-left"></i> Voltar</button>
            <button type="button" class="btn btn-primary" onclick="nextStep()">Próximo <i class="bi bi-arrow-right"></i></button>
        ...
        <div class="form-step">
            ...
            <div class="row">
                <div class="col-md-8 mb-3">
                    ...
                    <div class="invalid-feedback">Por favor, informe o nome completo do condutor.</div>
                </div>
                <div class="col-md-4 mb-3">
            ...
            <div class="condutor-retirar-block mb-3">
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        <label for="endossoCondutor1RetirarNome" class="form-label">Nome Completo *</label>
                        <input id="endossoCondutor1RetirarNome" class="form-control" required />
                        <div class="invalid-feedback">Por favor, informe o nome completo do condutor 1.</div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="endossoCondutor1RetirarCPF" class="form-label">CPF *</label>
                        <input id="endossoCondutor1RetirarCPF" class="form-control" placeholder="000.000.000-00" required />
                        <div class="invalid-feedback">Por favor, informe o CPF do condutor 1.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="condutor-retirar-block mb-3">
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <div class="invalid-feedback">Por favor, informe o nome completo do condutor 2.</div>
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="invalid-feedback">Por favor, informe o CPF do condutor 2.</div>
                    </div>
                </div>
            </div>
  ...
  endosso_dados_condutor_2: `
            <div class="form-step" data-step="4">
              ...
              <div class="mb-3">
                ...
                <input id="endossoCondutor1CNH" type="file" class="form-control" accept=".pdf,.jpg,.jpeg,.png" required />
                <div class="invalid-feedback">Por favor, anexe a CNH do condutor 1.</div>
              </div>
              <hr>
              ...
              <div class="mb-3">
                ...
                <div class="invalid-feedback">Por favor, anexe a CNH do condutor 2.</div>
              </div>
              <div class="btn-group-navigation">
                <button type="button" class="btn btn-secondary" onclick="prevStep()"><i class="bi bi-arrow-left"></i> Voltar</button>
                <button type="button" class="btn btn-primary" onclick="nextStep()">Próximo <i class="bi bi-arrow-right"></i></button>
  ...
  carta_cancelamento: `
        <div class="form-step" data-step="4">
          <div class="mb-3">
            ...
            <div class="invalid-feedback">Por favor, anexe a carta de cancelamento.</div>
          </div>
          <div class="btn-group-navigation">
            <button type="button" class="btn btn-secondary" onclick="prevStep()"><i class="bi bi-arrow-left"></i> Voltar</button>
            <button type="button" class="btn btn-primary" onclick="nextStep()">Próximo <i class="bi bi-arrow-right"></i></button>
  ...
  segunda_via_docs: `
        <div class="form-step" data-step="1">
          ...
          <div class="mb-3" id="segundaViaOutroContainer" style="display: none;">
            ...
            <input type="text" id="segundaViaOutroNome" class="form-control" required/>
            <div class="invalid-feedback">Por favor, especifique o documento.</div>
          </div>
          <div class="mb-3">
            <label class="form-label">Responsável pelo Pedido *</label>
            <input id="segundaViaResponsavel" class="form-control" required />
            <div class="invalid-feedback">Por favor, informe o responsável pelo pedido.</div>
          </div>
          <div class="mb-3">
        ...
        <div class="form-step" data-step="1">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <select id="segTrabalhadasFin" class="form-select" required>
                <option value="aruana">Aruana</option>
                <option value="porto">Porto Seguro</option>
                <option value="azul">Azul</option>
                <option value="allianz">Allianz</option>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <div class="invalid-feedback">Por favor, informe a parcela em aberto.</div>
            </div>
            <div class="col-md-6 mb-3">
          ...
          <div class="mb-3">
            ...
            <div class="invalid-feedback">Por favor, informe o motivo da inadimplência.</div>
          </div>
          <div class="row">
    ...
    <div class="form-step" data-step="1">
      ...
      <div id="parceiroSearchStep">
        ...
        <div class="input-group mb-3">
          ...
          <div class="invalid-feedback">Por favor, informe o código do parceiro.</div>
        </div>
...
<div class="form-step">
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-3">
        <label class="form-label">Número</label>
        <input type="number" id="novo_endereco_numero" class="form-control" required>
        <div class="invalid-feedback">Por favor, informe o número.</div>
      </div>
    </div>
    <div class="row">
    ...
    <div id="pernoiteCondicional" style="display: none;">
        <div class="alert alert-light border">
            <div class="mb-3">
                ...
                <div class="d-flex gap-3">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="alteraResidencia" id="alteraResidenciaSim" value="sim" data-rule="novoEnderecoResidenciaContainer:checked" required>
                        <label class="form-check-label" for="alteraResidenciaSim">Sim</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="alteraResidencia" id="alteraResidenciaNao" value="nao" required>
            ...
            <div id="novoEnderecoResidenciaContainer" style="display: none;">
                <h6 class="mt-3">Novo Endereço de Residência/Correspondência</h6>
                 <div class="row">
                  <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                      <input id="residencia_cep" class="form-control" placeholder="00000-000" required>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 mb-3">
                    <label class="form-label">Número</label>
                    <input type="number" id="residencia_numero" class="form-control" required>
                    <div class="invalid-feedback">Por favor, informe o número.</div>
                  </div>
                </div>
                 <div class="row">
                ...
                <div class="mb-3">
                  ...
                  <input id="comprovanteResidencia" type="file" class="form-control" accept=".jpg,.jpeg,.png,.pdf" required>
                  <div class="invalid-feedback">Por favor, anexe o comprovante de endereço.</div>
                </div>
            </div>
        </div>
...
<div class="form-step">
    ...
    <div id="novoCepPernoiteContainer" style="display: none;">
        <h6 class="mt-3">Novo Endereço de Pernoite</h6>
         <div class="row">
          <div class="col-md-4 mb-3">
            ...
            <div class="input-group">
              <input id="pernoite_cep" class="form-control" placeholder="00000-000" required>
        ...
        <div class="row">
          ...
          <div class="col-md-4 mb-3">
            <label class="form-label">Número</label>
            <input type="number" id="pernoite_numero" class="form-control" required>
            <div class="invalid-feedback">Por favor, informe o número.</div>
          </div>
        </div>
         <div class="row">
        ...
        <div class="mb-3">
          ...
          <input id="comprovantePernoite" type="file" class="form-control" accept=".jpg,.jpeg,.png,.pdf" required>
          <div class="invalid-feedback">Por favor, anexe o comprovante de endereço.</div>
        </div>
    </div>
